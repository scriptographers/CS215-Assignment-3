...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{q4ci.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{q4cii.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{q4di.jpg}
    \caption{D vs $\log(\sigma)$}
    \label{fig:my_label}
\end{figure}
$\boxed{ \sigma = 1 }$ yields the minimum value of $D$.\\
\\
$\boxed{D = 0.0061}$ for the $\sigma$ parameter that yielded the best LL.
